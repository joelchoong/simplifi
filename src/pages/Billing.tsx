                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <Card className="relative overflow-hidden border-2 border-emerald-500/20 shadow-xl shadow-emerald-900/5">
                        <div className="absolute top-0 right-0 p-4">
                            <Badge variant="secondary" className="bg-emerald-100 text-emerald-700 hover:bg-emerald-100 border-none px-3 py-1">
                                Active
                            </Badge>
                        </div>
                        <CardHeader className="pb-4">
                            ...
                            <CardDescription className="text-emerald-700/60 font-medium">Enjoy full access to all features during our beta phase.</CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-6">
                            ...
                            <Button className="w-full h-11 bg-emerald-600 hover:bg-emerald-700 text-white shadow-lg shadow-emerald-200" disabled>
                                Current Phase
                            </Button>
                        </CardContent>
                    </Card>
                    ...
                    <Card className="relative overflow-hidden bg-slate-50/50 border-dashed">
                        ...
                        <CardHeader className="pb-4">
                            ...
                            <CardDescription>Premium features for individual creators and power users.</CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-6">
                            <div className="flex items-baseline gap-1">
                            ...
                            <div className="space-y-3 py-4 border-t border-slate-200">
                                ...
                                <div className="flex items-center gap-3 text-sm text-muted-foreground">
                                    <Check className="w-4 h-4 text-blue-400" />
                                    <span>Enhanced Cloud Data Export</span>
                                </div>
                            </div>
